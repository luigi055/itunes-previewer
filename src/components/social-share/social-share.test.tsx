...
describe("Testing the social share component", () => {
  ...
  describe("specifying the shareURL property", () => {
    ...
    it("should show the correct url, icon and hidden message for the facebook Link", () => {
      ...
      expect(getByTestId(facebookLinkTestId).href).toBe(
        `${shareURLs.facebookURL}${randomURL}`
      );
      expect(getByTestId(facebookHiddenMessageTestid).textContent).toBe(
    ...
    it("should show the correct url, icon and hidden message for the twitter Link", () => {
      ...
      expect(getByTestId(twitterLinkTestId).href).toBe(
        `${shareURLs.twitterURL}${randomURL}`
      );
      expect(getByTestId(twitterHiddenMessageTestid).textContent).toBe(
    ...
    it("should show the correct url, icon and hidden message for the whatsapp Link", () => {
      ...
      expect(getByTestId(whatsappLinkTestId).href).toBe(
        `${shareURLs.whatsappURL}${randomURL}`
      );
      expect(getByTestId(whatsappHiddenMessageTestid).textContent).toBe(
